                                ...
                                <div key={groupIndex} className="relative">
                                    ...
                                    >
                                        ...
                                        <div className="mb-6 pb-6 border-b-2 border-orange-200">
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-4 py-2.5 text-base font-medium border-2 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent bg-white transition-all ${
                                                            ageGroupErrors[
                                                                groupIndex
                                                            ]?.label
                                                                ? "border-red-300"
                                            ...
                                            {ageGroupErrors[groupIndex]
                                                ?.overlap && (
                                                <p className="text-red-600 text-sm mt-3 flex items-center gap-2 bg-red-50 p-3 rounded-lg border border-red-200">
                                                    <AlertCircle size={16} />
                                                    {
                                                        ageGroupErrors[
                                                            groupIndex
