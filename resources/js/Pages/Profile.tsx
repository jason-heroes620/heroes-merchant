                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                        ...
                        <div className="flex">
                            {[
                                ...
                                <button
                                    key={tab.key}
                                    onClick={() =>
                                        setActiveTab(tab.key as "profile" | "password")
                                    }
                    ...
                    <div className="p-8">
                        {activeTab === "profile" ? (
                            ...
                            >
                                ...
                                {user.role === "merchant" && user.merchant && (
                                    <MerchantSection
                                        ...
                                        setIsEditing={setIsEditingMerchant}
                                    />
                                )}
                            </form>
                        ) : (
                            ...
                            >
                                <SectionTitle title="Update Your Password" icon={<Lock className="text-orange-600" size={20} />} />
