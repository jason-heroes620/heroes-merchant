...
export default function ViewReferralPage({
    ...
    const { bonus, threshold } = referral_settings;

    const creditsEarned = Math.floor(successfulReferrals / threshold) * bonus;
    const progressToNext =
        ((successfulReferrals % threshold) / threshold) * 100;
